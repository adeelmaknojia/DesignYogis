...
// Data Insertion In database
	$query="INSERT INTO website(BusinessName, BusinessDescription, BusinessIndustry, ExistingWeb, DesignDescription, Package, CustomBudget, OtherDescription, CustomerName, Country, Email, ContactNumber) VALUES ('$b_name', '$b_description', '$b_industry', '$b_web', '$d_description', '$package', '$custom_budget', '$other_description', '$c_name', '$country', '$email', '$c_no')";
