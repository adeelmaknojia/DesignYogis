...
// Data Insertion In database
	//Project Information
	$query="INSERT INTO banner(BusinessName, BusinessDescription, BusinessIndustry, DesignDescription, BannerSize, Package, CustomBudget, OtherDescription, CustomerName, Country, Email, ContactNumber) VALUES ('$b_name', '$b_description', '$b_industry', '$d_description', '$size', '$package', '$custom_budget', '$other_description', '$c_name', '$country', '$email', '$c_no')";
			...
			<div id="main">
				...
				<div class="wrapper">
					...
					<div id="content">
						...
						<!-- title -->
						<div id="page-title">
							<span class="title">Banner Design</span>
						...
						<div id="contactForm">
                            ...
                            <?php /*///////////////////////////////////////////////////*/ ?>
                            <p id="success" class="success">Thanks.<br>Your informaition has been recorded.</p>
                            </div>
						</div>
						<!-- ENDS column -->
