...
// Data Insertion In database
	//Project Information
	$query="INSERT INTO stationary(BusinessName, BusinessDescription, BusinessIndustry, BusinessAddress, BusinessContact, BusinessFax, BusinessEmail, Package, CustomBudget, OtherDescription, CustomerName, Country, Email, ContactNumber) VALUES ('$b_name', '$b_description', '$b_industry', '$b_address', '$b_contact', '$b_fax', 'b_email', '$package', '$custom_budget', '$other_description', '$c_name', '$country', '$email', '$c_no')";
			...
			<div id="main">
				...
				<div class="wrapper">
					...
					<div id="content">
						...
						<!-- title -->
						<div id="page-title">
							<span class="title">Stationery Design</span>
