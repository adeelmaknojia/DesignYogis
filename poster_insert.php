...
// Data Insertion In database
	//Project Information
	$query="INSERT INTO poster(BusinessName, BusinessDescription, BusinessIndustry, DesignDescription, PosterSize, Package, CustomBudget, OtherDescription, CustomerName, Country, Email, ContactNumber) VALUES ('$b_name', '$b_description', '$b_industry', '$d_description', '$poster_size', '$package', '$custom_budget', '$other_description', '$c_name', '$country', '$email', '$c_no')";
			...
			<div id="main">
				...
				<div class="wrapper">
					...
					<div id="content">
						...
						<!-- title -->
						<div id="page-title">
							<span class="title">Poster Design</span>
