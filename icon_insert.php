...
// Data Insertion In database
	//Project Information
	$query="INSERT INTO icon(BusinessName, BusinessDescription, BusinessIndustry, DesignDescription, Color, Package, CustomBudget, OtherDescription, CustomerName, Country, Email, ContactNumber) VALUES ('$b_name', '$b_description', '$b_industry', '$d_description', '$color', '$package', '$custom_budget', '$other_description', '$c_name', '$country', '$email', '$c_no')";
			...
			<div id="main">
				...
				<div class="wrapper">
					...
					<div id="content">
						...
						<!-- title -->
						<div id="page-title">
							<span class="title">Icon Design</span>
